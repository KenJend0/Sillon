...
const faq: { category: string; questions: { q: string; a: string }[] }[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { q: "Je ne reçois pas l'e-mail de confirmation à l'inscription", a: "Vérifie ton dossier spam. Si le problème persiste, contacte-nous à sillon.contact@proton.me en précisant l'adresse utilisée à l'inscription." },
      { q: 'Comment changer mon adresse e-mail ?', a: "La modification d'adresse e-mail n'est pas encore disponible directement dans l'app. Contacte-nous à sillon.contact@proton.me depuis ton adresse actuelle." },
      ...
      { q: 'Puis-je exporter mes données ?', a: "L'export automatique n'est pas encore disponible. Tu peux en faire la demande à sillon.contact@proton.me. Conformément au RGPD, nous répondrons sous 30 jours." },
  ...
  },
  {
    ...
    questions: [
      ...
      { q: 'Un album est manquant ou ses informations sont incorrectes. Que faire ?', a: "Si l'album n'apparaît pas dans la recherche, il n'est peut-être pas encore dans la base MusicBrainz. Une information erronée (titre, date, pochette...) vient aussi de cette base. Dans les deux cas, tu peux contribuer directement sur musicbrainz.org : la correction ou l'ajout sera repris sur Sillon une fois validé." },
      { q: 'Est-ce que Sillon propose du streaming musical ?', a: "Non. Sillon est un journal et réseau social musical, pas une plateforme de streaming. L'application n'héberge aucun fichier audio. Pour écouter un album, utilise Spotify, Apple Music, Deezer ou toute autre plateforme de ton choix." },
      { q: 'Les notes et avis sont-ils liés à d’autres sites ?', a: 'Non. Les notes et avis sur Sillon sont propres à la plateforme et à sa communauté. Ils ne sont pas synchronisés avec Last.fm, RateYourMusic ou d’autres services.' },
    ],
  },
];
...
export default function FAQScreen() {
  ...
  return (
    <ScrollView className="flex-1 bg-paper-hi" contentContainerStyle={{ paddingTop: insets.top + 12, paddingHorizontal: 16, paddingBottom: insets.bottom + 100 }}>
      ...
      <Pressable onPress={() => Linking.openURL('mailto:sillon.contact@proton.me')} className="mb-8">
