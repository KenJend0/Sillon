...
const resources = [
  { href: '/me/legal/faq', icon: HelpCircle, label: 'FAQ', description: 'Questions fréquentes sur l’utilisation de Sillon' },
  ...
  return (
    <ScrollView className="flex-1 bg-paper-hi" contentContainerStyle={{ paddingTop: insets.top + 12, paddingHorizontal: 16, paddingBottom: insets.bottom + 100 }}>
      ...
      <LegalSection title="Nous contacter">
        <Pressable
          onPress={() => Linking.openURL('mailto:sillon.contact@proton.me?subject=Support%20Sillon')}
