export default function Loading() {
    return (
        <div className="max-w-page mx-auto px-4 pt-4 pb-6 animate-pulse">
            ...
            {/* Track hero — cover 84px + titre/artiste/album */}
            <div className="mt-4 pb-5 border-b border-border">
                <div className="flex gap-4 items-end">
                    ...
                    <div className="flex-1 min-w-0 pb-1">
                        <div className="h-2 bg-background-secondary rounded w-8 mb-2" />
                        ...
                        <div className="flex items-center gap-2 mt-1.5">
                            ...
                            <div className="w-1 h-1 rounded-full bg-background-tertiary" />
