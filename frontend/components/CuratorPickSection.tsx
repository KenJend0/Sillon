...
function ExpandableNote({
    ...
    useEffect(() => {
        ...
        // non tronqué, clientHeight la hauteur visible après troncature : s'ils
        // diffèrent, il y a vraiment du texte caché à dérouler.
...
export default function CuratorPickSection({ pick }: { pick: CuratorPick }) {
    return (
        <section>
            <div className="mb-5">
            ...
            {/* Mobile : reprend exactement le mockup .scr-cur — pas de tampon de note, byline courte */}
            ...
            {/* Desktop : grande cover à gauche, tampon de note, cadre ornemental */}
